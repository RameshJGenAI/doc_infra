...
from activities import callAoai, getBlobContent, runDocIntel, writeToBlob
from configuration import Configuration
from pipelineUtils.azure_openai import run_prompt
from pipelineUtils.blob_functions import BlobMetadata, get_blob_content, write_to_blob
...
plan_type = os.getenv("FUNCTION_APP_PLAN_TYPE", "PremiumV3").lower()
is_flex_consumption = plan_type == "flexconsumption"
...
if is_flex_consumption:
    blob_trigger_kwargs["source"] = "EventGrid"

# Blob-triggered starter
@app.function_name(name="start_orchestrator_on_blob")
@app.blob_trigger(**blob_trigger_kwargs)
